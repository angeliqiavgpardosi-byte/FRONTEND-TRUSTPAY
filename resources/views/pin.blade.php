...
<<<<<<< HEAD
        ...
        .form-group input[type="text"] { -webkit-text-security: none; }
...
<<<<<<< HEAD
            <!-- Perbaikan: action diarahkan ke welcome -->
            <form method="POST" action="{{ route('welcome') }}">
                @csrf
                <div class="form-group">
                    <label>Buat PIN Baru</label>
                    <div class="input-wrapper">
                        <input type="password" id="p1" name="pin" placeholder="••••••" inputmode="numeric" oninput="validateInput(this)">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input type="password" id="p2" name="pin_confirmation" placeholder="••••••" inputmode="numeric" oninput="validateInput(this); checkMatch();">
                ...
                <button type="submit" class="btn-daftar" id="btnSubmit">Daftar</button>
            </form>
=======
            <div class="form-group">
                <label>Buat PIN Baru</label>
